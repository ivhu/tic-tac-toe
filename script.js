...
const DisplayController = (playerOne, playerTwo) => {
    ...
    const checkWinCon = () => {
        if (gb[0][0].getBtn().disabled && gb[0][1].getBtn().disabled && gb[0][2].getBtn().disabled) {
            if (gb[0][0].getToken() === gb[0][1].getToken() && gb[0][1].getToken() === gb[0][2].getToken()) {
                gameOver = true;
                disableAllBtns();
        ...
        if (gb[1][0].getBtn().disabled && gb[1][1].getBtn().disabled && gb[1][2].getBtn().disabled) {
            if (gb[1][0].getToken() === gb[1][1].getToken() && gb[1][1].getToken() === gb[1][2].getToken()) {
                gameOver = true;
                disableAllBtns();
        ...
        if (gb[2][0].getBtn().disabled && gb[2][1].getBtn().disabled && gb[2][2].getBtn().disabled) {
            if (gb[2][0].getToken() === gb[2][1].getToken() && gb[2][1].getToken() === gb[2][2].getToken()) {
                gameOver = true;
                disableAllBtns();
        ...
        if (gb[0][0].getBtn().disabled && gb[1][0].getBtn().disabled && gb[2][0].getBtn().disabled) {
            if (gb[0][0].getToken() === gb[1][0].getToken() && gb[1][0].getToken() === gb[2][0].getToken()) {
                gameOver = true;
                disableAllBtns();
                gb[0][0].getBtn().style.backgroundColor = highlight;
                gb[1][0].getBtn().style.backgroundColor = highlight;
        ...
        if (gb[0][1].getBtn().disabled && gb[1][1].getBtn().disabled && gb[2][1].getBtn().disabled) {
            if (gb[0][1].getToken() === gb[1][1].getToken() && gb[1][1].getToken() === gb[2][1].getToken()) {
                gameOver = true;
                disableAllBtns();
                gb[0][1].getBtn().style.backgroundColor = highlight;
                gb[1][1].getBtn().style.backgroundColor = highlight;
        ...
        if (gb[0][2].getBtn().disabled && gb[1][2].getBtn().disabled && gb[2][2].getBtn().disabled) {
            if (gb[0][2].getToken() === gb[1][2].getToken() && gb[1][2].getToken() === gb[2][2].getToken()) {
                gameOver = true;
                disableAllBtns();
                gb[0][2].getBtn().style.backgroundColor = highlight;
                gb[1][2].getBtn().style.backgroundColor = highlight;
        ...
        if (gb[0][0].getBtn().disabled && gb[1][1].getBtn().disabled && gb[2][2].getBtn().disabled) {
            if (gb[0][0].getToken() === gb[1][1].getToken() && gb[1][1].getToken() === gb[2][2].getToken()) {
                gameOver = true;
                disableAllBtns();
                gb[0][0].getBtn().style.backgroundColor = highlight;
                gb[1][1].getBtn().style.backgroundColor = highlight;
        ...
        if (gb[0][2].getBtn().disabled && gb[1][1].getBtn().disabled && gb[2][0].getBtn().disabled) {
            if (gb[0][2].getToken() === gb[1][1].getToken() && gb[1][1].getToken() === gb[2][0].getToken()) {
                gameOver = true;
                disableAllBtns();
                gb[0][2].getBtn().style.backgroundColor = highlight;
                gb[1][1].getBtn().style.backgroundColor = highlight;
